...
class m2_initial_data extends \phpbb\db\migration\migration
{
	...
	{
		return array(
			array('config.add', array('rs_enable', '1')),
			...
			array('config.add', array('rs_post_rating', '2')),
			array('config.add', array('rs_anti_time', '0')),
			array('config.add', array('rs_anti_post', '0')),
			array('config.add', array('rs_anti_method', '0')),
			array('config.add', array('rs_user_rating', '1')),
			array('config.add', array('rs_user_rating_gap', '24')),
			...
			array('config.add', array('rs_enable_power', '0')),
